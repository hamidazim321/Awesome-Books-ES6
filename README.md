...
**Awesome Books ES6** is a project in Module 2 of Microverse Full Stack Program. It allows users to keep a list of books and add and remove books from the list and uses new features in JavaScript introduced by ES6.
